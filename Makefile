...
pkgdatadir = $(datadir)/pgadmin3
pkgincludedir = $(includedir)/pgadmin3
pkglibdir = $(libdir)/pgadmin3
pkglibexecdir = $(libexecdir)/pgadmin3
...
DIST_COMMON = $(srcdir)/Makefile.am $(top_srcdir)/configure \
	$(am__configure_deps) $(am__nobase_dist_data_DATA_DIST) \
...
am__nobase_dist_data_DATA_DIST = $(top_srcdir)/docs/en_US/*.css \
...
am__installdirs = "$(DESTDIR)$(datadir)" "$(DESTDIR)$(pkgdatadir)"
am__nobase_dist_pkgdata_DATA_DIST = $(top_srcdir)/docs/en_US/*.css \
	$(top_srcdir)/docs/en_US/hints/*.html \
	$(top_srcdir)/docs/cs_CZ/*.css \
	$(top_srcdir)/docs/cs_CZ/hints/*.html \
	$(top_srcdir)/docs/de_DE/*.css \
...
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/config.h.in \
	...
	$(top_srcdir)/pgadmin/include/libssh2/libssh2_config.h.in \
	INSTALL README TODO config/compile config/config.guess \
...
ACLOCAL = ${SHELL} /root/pgAdmin3-master/config/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} /root/pgAdmin3-master/config/missing autoconf
AUTOHEADER = ${SHELL} /root/pgAdmin3-master/config/missing autoheader
AUTOMAKE = ${SHELL} /root/pgAdmin3-master/config/missing automake-1.15
AWK = mawk
BUILD_DEBUG = no
CC = gcc
...
CFLAGS = -O2
CPP = gcc -E
CPPFLAGS =  -I/usr/include/postgresql -I/usr/include/postgresql/10/server -I/usr/include/postgresql -DHAVE_CONNINFO_PARSE -I/usr/lib/x86_64-linux-gnu/wx/include/gtk2-unicode-3.0 -I/usr/include/wx-3.0 -D_FILE_OFFSET_BITS=64 -DWXUSINGDLL -D__WXGTK__ -DEMBED_XRC -I/usr/include/libxml2 -I/usr/include/libxml2 -DHAVE_OPENSSL_CRYPTO -DLIBSSH2_OPENSSL
CXX = g++
...
LDFLAGS =  -L/usr/lib/x86_64-linux-gnu -Wl,-as-needed -L/usr/lib
LIBGCRYPT = 
LIBGCRYPT_PREFIX = 
LIBOBJS = 
LIBS =  -L/usr/lib/x86_64-linux-gnu -lcrypto -lpq /usr/lib/x86_64-linux-gnu/libssl.so /usr/lib/x86_64-linux-gnu/libcrypto.so -Wl,-rpath -Wl,/usr/lib/x86_64-linux-gnu /usr/lib/x86_64-linux-gnu/libz.so -Wl,-rpath -Wl,/usr/lib/x86_64-linux-gnu
LIBSREQUIRED = libssl,libcrypto
LIBSSL = /usr/lib/x86_64-linux-gnu/libssl.so /usr/lib/x86_64-linux-gnu/libcrypto.so -Wl,-rpath -Wl,/usr/lib/x86_64-linux-gnu
LIBSSL_PREFIX = 
LIBZ = /usr/lib/x86_64-linux-gnu/libz.so -Wl,-rpath -Wl,/usr/lib/x86_64-linux-gnu
LIBZ_PREFIX = 
LTLIBGCRYPT = 
LTLIBOBJS = 
LTLIBSSL = -L/usr/lib/x86_64-linux-gnu -lssl -L/usr/lib/x86_64-linux-gnu -lcrypto -R/usr/lib/x86_64-linux-gnu
LTLIBZ = -L/usr/lib/x86_64-linux-gnu -lz -R/usr/lib/x86_64-linux-gnu
MAKEINFO = ${SHELL} /root/pgAdmin3-master/config/missing makeinfo
MKDIR_P = /bin/mkdir -p
OBJEXT = o
PACKAGE = pgadmin3
PACKAGE_BUGREPORT = pgadmin-support@postgresql.org
PACKAGE_NAME = pgadmin3
PACKAGE_STRING = pgadmin3 1.22.2
...
abs_builddir = /root/pgAdmin3-master
abs_srcdir = /root/pgAdmin3-master
abs_top_builddir = /root/pgAdmin3-master
abs_top_srcdir = /root/pgAdmin3-master
ac_ct_CC = gcc
ac_ct_CXX = g++
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /root/pgAdmin3-master/config/install-sh
...
pdfdir = ${docdir}
pgScript_LDADD = -L/usr/lib/x86_64-linux-gnu -pthread   -lwx_baseu-3.0 -lwx_gtk2u_core-3.0 -lwx_baseu_xml-3.0 
pgadmin3_LDADD = -L/usr/lib/x86_64-linux-gnu -pthread   -lwx_gtk2u_stc-3.0 -lwx_gtk2u_aui-3.0 -lwx_gtk2u_xrc-3.0 -lwx_gtk2u_html-3.0 -lwx_gtk2u_qa-3.0 -lwx_gtk2u_adv-3.0 -lwx_gtk2u_core-3.0 -lwx_baseu_xml-3.0 -lwx_baseu_net-3.0 -lwx_baseu-3.0  -lxml2 -lxslt -lxml2
pgsTest_LDADD = -L/usr/lib/x86_64-linux-gnu -pthread   -lwx_baseu-3.0 -lwx_gtk2u_core-3.0 -lwx_baseu_xml-3.0 
png2c_LDADD = 
...
pgadmin/include/libssh2/libssh2_config.h: pgadmin/include/libssh2/stamp-h2
	@test -f $@ || rm -f pgadmin/include/libssh2/stamp-h2
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) pgadmin/include/libssh2/stamp-h2

pgadmin/include/libssh2/stamp-h2: $(top_srcdir)/pgadmin/include/libssh2/libssh2_config.h.in $(top_builddir)/config.status
	@rm -f pgadmin/include/libssh2/stamp-h2
	cd $(top_builddir) && $(SHELL) ./config.status pgadmin/include/libssh2/libssh2_config.h

distclean-hdr:
	-rm -f config.h stamp-h1 pgadmin/include/libssh2/libssh2_config.h pgadmin/include/libssh2/stamp-h2
...
installdirs-am:
	for dir in "$(DESTDIR)$(datadir)" "$(DESTDIR)$(pkgdatadir)"; do \
...
.PHONY: $(am__recursive_targets) CTAGS GTAGS TAGS all all-am \
	...
	tags-am uninstall uninstall-am uninstall-nobase_dist_dataDATA \
	uninstall-nobase_dist_pkgdataDATA
